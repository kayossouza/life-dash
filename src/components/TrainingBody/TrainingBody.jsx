...
const TrainingBody = () => {
  ...
  console.log('TrainingBody: Received trainings data:', trainings);
  console.log('TrainingBody: toggleTrainingCompleted function available:', !!toggleTrainingCompleted);
  useTheme(); // Use theme context

  // Call the toggleTrainingCompleted function directly
  const handleToggleTrainingCompleted = (index) => {
    console.log('TrainingBody: toggling completed for index', index);
